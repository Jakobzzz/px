...
//
//	btRigidBody* Picking::PerformMousePicking(std::shared_ptr<Camera>& camera, float x, float y)
//	{
...
//
//		return RayCast(Physics::ToBulletVector(camera->GetPosition()), Physics::ToBulletVector(m_pickedRay));
//	}
//
